...
<head>
   ...
   <meta charset="utf-8">
	...
	<meta name="description" content="UraidLAN">
	<meta name="author" content="Jacob Kleinig">
	<meta property="og:image" content="https://uraidlan.net/images/logo.png" />
	<meta property="og:description" content="UraidLAN starts on Friday at 7:00 PM and run until 7:00 PM on the Sunday. As a 48hr event you're not expected to stay through the whole event, most people pop in for a day at a time and float out." />
	<meta property="og:url"content="https://uraidlan.net/" />
	<meta property="og:title" content="UraidLAN" />
...
<?php
	...
	';
		...
		echo '
				<iframe width="1280" height="720" src="https://www.youtube.com/embed/live_stream?channel=UCHNLeudWtKfLNeddB8XGIuQ" frameborder="0" allowfullscreen></iframe>
		';
	}
?>								
			<li><a href="https://www.facebook.com/UraidLAN/"><i class="fab fa-facebook"></i></a></li>
<!--			<li><a href="#"><i class="fa fa-twitter"></i></a></li>			-->
<!--			<li><a href="#"><i class="fa fa-google-plus"></i></a></li>		-->
			<li><a href="https://www.youtube.com/channel/UCHNLeudWtKfLNeddB8XGIuQ"><i class="fab fa-youtube"></i></a></li>
			<li><a href="https://discord.me/uraidlan"><i class="fab fa-discord"></i></a></li>
			<li><a href="http://steamcommunity.com/groups/UraidLAN"><i class="fab fa-steam"></i></a></li>
			<li><a href="https://github.com/UraidLAN"><i class="fab fa-github"></i></a></li>
		...
		<hr>
			...
			<div class="four columns add-bottom">
				...
				<ul class="disc">
					...
					<li><b>$25 for Internet and Power access</b></li>
		...
		<div class="contacts">		
			...
			<div class="row contact-details">		           		         
			   ...
			   <div class="columns">
				   ...
				   <a href="https://goo.gl/maps/usZwaGeyqCK2">
   ...
   <footer>
      ...
      <div class="row">
         ...
         <div class="twelve columns">            
            ...
            <ul class="copyright">
               <li>&copy; Copyright 2018 UraidLAN</li>
               <li>Design by <a title="Kleinig" href="http://www.styleshout.com/">Styleshout</a></li>
